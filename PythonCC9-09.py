...
class ElectricCar(Car):
    ...
    def __init__(self, make, model, year):
        ...
        self.battery = Battery() # An instance of the class battery is now an attribute of any electric car.
...
class Battery():
    ...
    def upgrade_battery(self):
        """Upgrades battery size to 85 kWh"""
        if self.battery_size < 85:
            self.battery_size = 85
            print('The battery has been upgraded to 85 kWh!')
        else:
            print("The battery doesn't need upgrading!")
